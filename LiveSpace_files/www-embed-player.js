...
function b(p){for(var w=g,r=0;64>r;r+=4)w[r/4]=p[r]<<24|p[r+1]<<16|p[r+2]<<8|p[r+3];for(r=16;80>r;r++)p=w[r-3]^w[r-8]^w[r-14]^w[r-16],w[r]=(p<<1|p>>>31)&4294967295;p=e[0];var E=e[1],T=e[2],na=e[3],yc=e[4];for(r=0;80>r;r++){if(40>r)if(20>r){var Ha=na^E&(T^na);var Gb=1518500249}else Ha=E^T^na,Gb=1859775393;else 60>r?(Ha=E&T|na&(E|T),Gb=2400959708):(Ha=E^T^na,Gb=3395469782);Ha=((p<<5|p>>>27)&4294967295)+Ha+yc+Gb+w[r]&4294967295;yc=na;na=T;T=(E<<30|E>>>2)&4294967295;E=p;p=Ha}e[0]=e[0]+p&4294967295;e[1]=
e[1]+E&4294967295;e[2]=e[2]+T&4294967295;e[3]=e[3]+na&4294967295;e[4]=e[4]+yc&4294967295}
...
bi={},ci=(bi.mver="MEASUREMENT_VERSION_",bi.pis="PLAYER_INITIALIZED_STATE_",bi.yt_pt="LATENCY_PLAYER_",bi.pa="LATENCY_ACTION_",bi.yt_vst="VIDEO_STREAM_TYPE_",bi),di="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni pc pfa pfeh pftr prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts".split(" ");
...
;var gi={vc:!0},hi=!1;
function ii(){Mh().yt_lt="hot_bg";if(ei()){var a="hot_bg";var b=fi();if(b.gelInfos)b.gelInfos.info_yt_lt=!0;else{var c={};b.gelInfos=(c.info_yt_lt=!0,c)}if("yt_lt"in $h){b=$h.yt_lt;0<=Ja(ai,b)&&(a=!!a);"yt_lt"in ci&&"string"===typeof a&&(a=ci.yt_lt+a.toUpperCase());b=b.split(".");for(var d=c={},e=0;e<b.length-1;e++){var f=b[e];d[f]={};d=d[f]}d[b[b.length-1]]=a;a=Uh({},c)}else 0<=Ja(di,"yt_lt")||(a=new Zh("Unknown label logged with GEL CSI"),a.params="yt_lt",fe(a)),a=void 0;a&&ei()&&(b=fi(),"gelInfos"in
...
function ki(){if(!ei()){var a=Lh(),b=Mh(),c=a._start;for(f in a)if(0==f.lastIndexOf("_",0)&&z(a[f])){var d=f.slice(1);if(d in gi){var e=La(a[f],function(l){return Math.round(l-c)});
b["all_"+d]=e.join()}delete a[f]}e=O("CSI_SERVICE_NAME","youtube");var f={v:2,s:e,action:O("TIMING_ACTION",void 0)};d=ii.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var g=window.location.protocol+y("ytplayer.config.assets.js");(g=X.getEntriesByName?X.getEntriesByName(g)[0]:null)?b.h5jse=Math.round(b.h5jse-g.responseEnd):delete b.h5jse}a.aft=ji();Kh()&&"youtube"==e&&(ii(),e=a.vc,g=a.pbs,delete a.aft,b.aft=Math.round(g-e));for(var h in b)"_"!=h.charAt(0)&&(f[h]=b[h]);a.ps=U();h={};e=[];for(var k in a)"_"!=
k.charAt(0)&&(g=Math.round(a[k]-c),h[k]=g,e.push(k+"."+g));f.rt=e.join(",");(a=y("ytdebug.logTiming"))&&a(f,h);Jh(f,!!b.ap);Bg(Ih,new Gh(h.aft+(d||0),void 0))}}
A(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||wa,X);function li(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
function mi(a,b,c){"string"===typeof a&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});b=/\/([ve]|embed)\/([^#?]+)/.exec(a.mediaContentUrl);a.videoId=b&&b[2]?b[2]:null;return ni(a)}
function ni(a,b,c){if(Ba(a)){b=["endSeconds","startSeconds","mediaContentUrl","suggestedQuality","videoId"];c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function oi(a,b,c,d){if(Ba(a)&&!z(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
;function pi(a){a=void 0===a?!1:a;K.call(this);this.f=new M(a);Sc(this,Ga(Tc,this.f))}
...
wi.prototype.m=function(){si.prototype.m.call(this);delete this.i};function xi(a,b,c){K.call(this);var d=this;c=c||O("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.h=b||null;this.w="*";this.i=c;this.sessionId=null;this.channel="widget";this.B=!!a;this.o=function(e){a:if(!("*"!=d.i&&e.origin!=d.i||d.h&&e.source!=d.h||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.B&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
this))}
t(Bi,yi);m=Bi.prototype;m.la=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&li(a)){var d=b;if(Ba(d[0])&&!z(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=ni.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=mi.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=oi.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);li(a)&&Ai(this,this.fa())}};
...
m.dispose=function(){yi.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function Ci(a,b,c){K.call(this);this.f=a;this.i=c;this.j=V(window,"message",A(this.l,this));this.h=new qi(this,a,b);Sc(this,Ga(Tc,this.h))}
...
Ci.prototype.m=function(){Qf(this.j);this.f=null;K.prototype.m.call(this)};function Di(){var a=Za(Ei),b;return ud(new L(function(c,d){a.onSuccess=function(e){se(e)?c(e):d(new Fi("Request failed, status="+e.status,"net.badstatus",e))};
...
return sd(c)})}
function Fi(a,b){D.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
t(Fi,D);function Gi(){this.g=0;this.f=null}
...
;function Ji(a){D.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Ki;this.isTimeout=a instanceof Fi&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof vd}
t(Ji,D);Ji.prototype.name="BiscottiError";function Ki(){D.call(this,"Biscotti ID is missing from server")}
t(Ki,D);Ki.prototype.name="BiscottiMissingError";var Ei={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Li=null;function ce(){if("1"===Ta(ae(),"args","privembed"))return sd(Error("Biscotti ID is not available in private embed mode"));Li||(Li=ud(Di().then(Mi),function(a){return Ni(2,a)}));
return Li}
...
function Oi(a,b){R(function(){ud(Di().then(Mi,function(c){return Ni(b,c)}),wa)},a)}
function Pi(){try{var a=y("yt.ads.biscotti.getId_");return a?a():ce()}catch(b){return sd(b)}}
;function Qi(a){if("1"!==Ta(ae(),"args","privembed")){a&&be();try{Pi().then(function(){},function(){}),R(Qi,18E5)}catch(b){P(b)}}}
;var Z=y("ytglobal.prefsUserPrefsPrefs_")||{};x("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function Ri(){this.f=O("ALT_PREF_COOKIE_NAME","PREF");var a=Tb.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
...
xa(Ri);var Vi=null,Wi=null,Xi=null,Yi={};function Zi(a){var b=a.id;a=a.ve_type;var c=ug++;a=new sg({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});Yi[b]=a;b=ch();c=bh();b&&c&&Lg(b,c,[a])}
function $i(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(dh(b,a),a=bh()))for(var c in Yi){var d=Yi[c];d&&Lg(b,a,[d])}}
function aj(a){Yi[a.id]=new sg({trackingParams:a.tracking_params})}
function bj(a){var b=ch(),c=Yi[a.id];if(b&&c){a=Mg;c={csn:b,ve:tg(c),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"};var d={ca:void 0,P:b};"UNDEFINED_CSN"==b?Ng("visualElementGestured",c,d):rg("visualElementGestured",c,a,d)}}
function cj(a){a=a.ids;var b=ch();if(b)for(var c=0;c<a.length;c++){var d=Yi[a[c]];if(d){var e=Mg;d={csn:b,ve:tg(d),eventType:1};var f={ca:void 0,P:b};"UNDEFINED_CSN"==b?Ng("visualElementShown",d,f):rg("visualElementShown",d,e,f)}}}
...
x("writeEmbed",function(){var a=O("PLAYER_CONFIG",void 0);Qi(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=O("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);O("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");b="player";b="string"===typeof b?Zb(b):b;var d=Ch+"_"+(b[Ca]||(b[Ca]=++Da)),e=Bh[d];e&&(void 0===f||f)?e.loadNewVideoConfig(a):(e=new mh(b,d,a,void 0),Bh[d]=e,df("player-added",e.api),Sc(e,Ga(Dh,e)));a=e.api;
Vi=a;a.addEventListener("onScreenChanged",$i);a.addEventListener("onLogClientVeCreated",Zi);a.addEventListener("onLogServerVeCreated",aj);a.addEventListener("onLogVeClicked",bj);a.addEventListener("onLogVesShown",cj);var f=O("POST_MESSAGE_ID","player");O("ENABLE_JS_API")?Xi=new Bi(a):O("ENABLE_POST_API")&&"string"===typeof f&&"string"===typeof c&&(Wi=new Ci(window.parent,f,c),Xi=new wi(a,Wi.h));c=$d("BG_P");Gf(c)&&(O("BG_I")||O("BG_IU"))&&(Cf=!0,Bf.initialize(O("BG_I",null),O("BG_IU",null),c,Ff,void 0));
wf()},void 0);
x("yt.www.watch.ads.restrictioncookie.spr",function(a){Ke(a+"mac_204?action_fcts=1");return!0},void 0);
var dj=ee(function(){var a=Lh(),b;(b=!Q("use_first_tick"))||(b=!("ol"in Lh()));if(b&&(b="ol",X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b)),b=U(),a.ol&&(a._ol=a._ol||[a.ol],a._ol.push(b)),a.ol=b,a=fi(),a.gelTicks&&(a.gelTicks.tick_ol=!0),U(),ei()?(a=Oh(),Sh("tick_ol_"+a)||Ph("latencyActionTicked",{tickName:"ol",clientActionNonce:a},{timestamp:void 0}),a=!0):a=!1,!a&&!y("yt.timing.pingSent_")&&(b=O("TIMING_ACTION",void 0),a=Lh(),y("ytglobal.timingready_")&&b&&a._start&&(b=ji())))){hi||
(Bg(Hh,new Fh(Math.round(b-a._start),void 0)),hi=!0);b=!0;var c=O("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&ki()}a=Ri.getInstance();c=!!((Ui("f"+(Math.floor(119/31)+1))||0)&67108864);b=1<window.devicePixelRatio;document.body&&Xc(document.body,"exp-invert-logo")&&(b&&!Xc(document.body,"inverted-hdpi")?(d=document.body,d.classList?d.classList.add("inverted-hdpi"):Xc(d,"inverted-hdpi")||(e=Vc(d),Wc(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi")))):
!b&&Xc(document.body,"inverted-hdpi")&&Yc());c!=b&&(c="f"+(Math.floor(119/31)+1),d=Ui(c)||0,d=b?d|67108864:d&-67108865,0==d?delete Z[c]:(b=d.toString(16),Z[c]=b.toString()),a.save())}),ej=ee(function(){var a=Vi;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();O("PL_ATT")&&Bf.dispose();a=0;for(var b=uf.length;a<b;a++){var c=uf[a];if(!isNaN(c)){var d=y("yt.scheduler.instance.cancelJob");d?d(c):S(c)}}uf.length=0;of("//static.doubleclick.net/instream/ad_status.js");vf=!1;N("DCLKSTAT",0);Uc(Xi,Wi);if(a=Vi)a.removeEventListener("onScreenChanged",$i),a.removeEventListener("onLogClientVeCreated",Zi),a.removeEventListener("onLogServerVeCreated",aj),a.removeEventListener("onLogVeClicked",bj),a.removeEventListener("onLogVesShown",
cj),a.destroy();Yi={}});
window.addEventListener?(window.addEventListener("load",dj),window.addEventListener("unload",ej)):window.attachEvent&&(window.attachEvent("onload",dj),window.attachEvent("onunload",ej));Ia("yt.abuse.player.botguardInitialized",y("yt.abuse.player.botguardInitialized")||Hf);Ia("yt.abuse.player.invokeBotguard",y("yt.abuse.player.invokeBotguard")||If);Ia("yt.abuse.dclkstatus.checkDclkStatus",y("yt.abuse.dclkstatus.checkDclkStatus")||xf);
